  ...
  return (
    <section id="projects" className="section-pad relative">
      <div className="mx-auto max-w-7xl px-4">
        ...
        {/* Featured */}
        <article className="mt-14 group glass rounded-3xl overflow-hidden grid lg:grid-cols-2">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          {rest.map((p) => (
            <article key={p.title} className="group glass rounded-2xl overflow-hidden hover:-translate-y-1 transition-all">
