      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {services.map((s, i) => (
            <article
              key={s.title}
              className="group glass rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/8 to-transparent p-6 relative overflow-hidden shadow-[0_18px_50px_-24px_rgba(0,0,0,0.7)] hover:-translate-y-1 transition-all duration-300"
            >
